...
class Tf_Results_without_generator:
    def __init__(self,model,X_test,Y_test):
        ...
        self.xtest = X_test
        self.ytest = Y_test  
        # stores the validation generator object   
        try:                        
    ...
    def tf_roc_curve(self,figure_name="roc.jpeg",labels=None):
        ...
        if labels == None:
            labels = self.ytest
        preds = self.model.predict(self.xtest,self.ytest,verbose=1)
    ...
    def tf_confusion_matrix(self,figure_name='confusion_matrix.jpeg'):
        '''
    ...
    def tf_get_results_docx(self,file_name="model_report.docx"):
        '''
...
The Precision Recall Curve for the Input Model is as shown:
                        ''')
